...
def main():
    ...
    output_file = result_dir / "j90_with_bound_1200s.csv"
    ...
    local_path = "result/j90_with_bound_1200s.csv"
    blob_name = f"results/{os.path.basename(local_path)}"  # ví dụ "results/j90_with_bound_1200s.csv"
